...
public class menuIdioma : MonoBehaviour {
    ...
    private static string[] idiomaEspañol = {"Perfil","Nueva Partida","Buscar Partida","Clasificación","Salir"};
    private static string[] idiomaIngles = { "Profile", "New Game", "Search Game", "Ranking", "Exit"};
